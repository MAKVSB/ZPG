...
void AssimpLoaderScene::createModels()
{
	...
	loadedModel6->setPosition(glm::vec3(22, 10, 4));
	...
	light5->setPosition(glm::vec3(22, 10.308f, 4.940));
	light5->setLightDirection(glm::vec3(0, -16, 0));
	light5->setLightColor(glm::vec3(1, 1, 1));
	light5->setLightAttenuation(glm::vec3(0, 0, 0.1f));
	light5->setLightStrength(32.0f);
	models.push_back(light5);

	Light* light6 = new Light();
	light6->setLightType(LightType::POINT);
	light6->setPosition(glm::vec3(22, 10.308f, 4.940));
	light6->setLightDirection(glm::vec3(0, -16, 0));
	light6->setLightColor(glm::vec3(1, 1, 1));
	light6->setLightAttenuation(glm::vec3(0, 0, 0.01f));
	light6->setLightStrength(32.0f);
	models.push_back(light6);

	Light* light7 = new Light();
	light7->setLightType(LightType::SPOTLIGHT);
	light7->setPosition(glm::vec3(21.912, 10.420f, 1.103f));
	light7->setLightDirection(glm::vec3(0, 0, 0));
	light7->setLightColor(glm::vec3(1, 0, 0));
	light7->setLightAttenuation(glm::vec3(0, 0, 1.7f));
	light7->setLightStrength(32.0f);
	light7->setCutoff(140);
	models.push_back(light7);
	...
	for (int i = 0; i < 20; i++) {
		...
		randlight->setLightStrength(32.0f);
...
void AssimpLoaderScene::tick(float deltaTime)
{
	...
	((Light*)models[2])->setLightDirection(*camera->getRotation());
...
void AssimpLoaderScene::listen(MessageType messageType, void* object)
{
	if (messageType == MessageType::MouseButtonPressed) {
		int x = ((CallbackManager::CBButtonData*)object)->mousePos.x;
		int y = ((CallbackManager::CBButtonData*)object)->mousePos.y;
		...
		GameObject* goToDelete = getGameObjectByIndex(index);
